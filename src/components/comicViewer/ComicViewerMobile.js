...
export default function ComicViewerMobile(props) {
  const {
    driveLink,
    editionTitle,
    images,
    ...
    <>
      ...
      <div className="w-full min-h-screen bg-[#121826]">
        ...
        {images.length > 0 && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 z-50 bg-red-600/70 text-white p-3 rounded-full shadow-lg hover:bg-red-700/90 transition"
